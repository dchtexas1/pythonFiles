...
sounds = [pygame.mixer.Sound("one.wav"), pygame.mixer.Sound(
    "two.wav"), pygame.mixer.Sound("three.wav"), pygame.mixer.Sound("four.wav")]
...
def lose():
    for i in range(0, 4):
        ...
        sleep(0.5)
    if (len(seq) == 1):
        print "You didn't get anything right!"
    else:
        print "You made it to {}!".format(len(seq))
